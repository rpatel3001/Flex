...
if(tipuesearch.pages[i].tags.join())
{if(tipuesearch.pages[i].tags.join().search(pat)!=-1)
{var m_c=tipuesearch.pages[i].tags.join().match(pat).length;score+=(10*m_c);}}
...
if(d_w[f].match('^-'))
{pat=new RegExp(d_w[f].substring(1),'i');if(tipuesearch.pages[i].title.search(pat)!=-1||tipuesearch.pages[i].text.search(pat)!=-1||tipuesearch.pages[i].tags.join().search(pat)!=-1)
{score=0;}}}
if(score!=0)
